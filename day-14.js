...
class Universe {
    ...
    addReaction (output, inputs) {
        this.elements[output.element] = new Element({name: output.element, produceQuantity: output.quantity, inputs})
    }
    ...
    oreFor(quantity, elementName, surplus = {}) {
        ...
        surplus[elementName] += (element.formuleOutputQuantity * nbReactionsNeeded) - quantity
        return ore;
    }
}
